...
botonGenerar.addEventListener("click", () => {
  //escucho al botón que crea las cartas, lo asocio a la fx dibujar y lo guardo en una variable
...
function cambiarValor(valor) {
  //función que condiciona algunos valores de las cartas para que aparezcan en el orden deseado
  switch (valor) {
    case 1:
      return "A";
    case 10:
